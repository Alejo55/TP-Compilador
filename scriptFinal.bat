...
gcc.exe lex.yy.c y.tab.c Lista.c Pila.c Lista-inter.c -o lyc-compiler-2.0.0.exe
echo "Se compilaron los archivos correspondientes utilizando GCC (Se creo un archivo lyc-compiler-2.0.0.exe)"

lyc-compiler-2.0.0.exe test.txt
echo "Se ejecuto el programa compilado lyc-compiler-2.0.0.exe sobre el archivo test.txt"
