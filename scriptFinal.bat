...
gcc.exe lex.yy.c y.tab.c Lista.c -o lyc-compiler-1.0.0.exe
echo "Se compilaron los archivos lex.yy.c, y.tab.c y Lista.c utilizando GCC (Se creo un archivo lyc-compiler-1.0.0.exe)"

lyc-compiler-1.0.0.exe test.txt
echo "Se ejecuto el programa compilado lyc-compiler-1.0.0.exe sobre el archivo test.txt"
